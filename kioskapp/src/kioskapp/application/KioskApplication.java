		...
		frame.getBtnAdd().addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String messageContent = "The following order has been added:\n"
						...
						+ String.format("SubTotal: %.2f", orderedItem.getSubTotalAmount())+"\n";
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(orderTransaction.isTransactionStatus()) {
						...
						//Remove String path so that the file will generate in local file
						String fileName = orderTransaction.getTransactioDate().toString() + "_"
